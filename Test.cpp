...
int main() {
	...
	if (signal == 0) {
	  ...
	  SmartGuesser schooser;
		...
		.CHECK_OUTPUT(calculateBullAndPgia("1223","4225"), "2,0")     
		.CHECK_OUTPUT(calculateBullAndPgia("1","1"), "1,0")     
		.CHECK_OUTPUT(calculateBullAndPgia("5567","7569"), "2,1")     
		.CHECK_OUTPUT(calculateBullAndPgia("5663","6583"), "1,2")  
		.CHECK_OUTPUT(calculateBullAndPgia("3698","8963"), "0,4")  
		.CHECK_OUTPUT(calculateBullAndPgia("5201","4321"), "1,1")  
		.CHECK_OUTPUT(calculateBullAndPgia("6543","1258"), "0,1")  
		.CHECK_OUTPUT(calculateBullAndPgia("9546","4321"), "0,1")  
		.CHECK_OUTPUT(calculateBullAndPgia("56","65"), "0,2")    
		.CHECK_OUTPUT(calculateBullAndPgia("25894","28795"), "2,2")   
		...
		.CHECK_OUTPUT(calculateBullAndPgia("6589","1568458"), "1,2")     
